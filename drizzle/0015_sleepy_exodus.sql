...
ALTER TABLE "scheduled_message_states" ADD COLUMN "revision" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "scheduled_message_audits" ADD CONSTRAINT "scheduled_message_audits_event_check" CHECK ("scheduled_message_audits"."event" in ('CREATED', 'CANCELLED', 'EDITED', 'RESCHEDULED', 'EXECUTION_COMPLETED', 'EXECUTION_RETRY', 'EXECUTION_FAILED'));--> statement-breakpoint
ALTER TABLE "scheduled_message_audits" ADD CONSTRAINT "scheduled_message_audits_shape_check" CHECK ((
        ...
        "scheduled_message_audits"."event" in ('EDITED', 'RESCHEDULED')
        and "scheduled_message_audits"."actor_type" = 'USER' and "scheduled_message_audits"."actor_id" is not null
        and "scheduled_message_audits"."outcome" = 'SUCCESS' and "scheduled_message_audits"."failure_code" is null
        and "scheduled_message_audits"."result_message_id" is null
      ) or (
...
ALTER TABLE "scheduled_message_states" ADD CONSTRAINT "scheduled_message_states_revision_check" CHECK ("scheduled_message_states"."revision" >= 0);